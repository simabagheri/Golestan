  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 main">
      <div class="col-sm-3" id="menu">
        <a href="<spring:url value="/teacher/students"/>"><div class="menuitem">مدیریت دانشجویان</div></a>
        <a href="<spring:url value="/teacher/profile"/>"><div class="menuitem">تغییر اطلاعات شخصی</div></a>
        <a href="<spring:url value="/teacher/password"/>"><div class="menuitem">تغییر رمز ورود</div></a>
        <a href="<spring:url value="/teacher/welcome"/>"><div class="menuitem">خروج از سیستم</div></a>
      </div>
      <div class="col-sm-9" id="body">
        <div style="padding: auto; text-align: center">
          استاد عزیز، به سیستم آموزش خوش آمدید!
        </div>
      </div>
